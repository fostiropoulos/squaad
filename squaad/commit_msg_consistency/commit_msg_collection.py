...
def collect_commit_data(name):
	...
	for app, app_commits in commits_by_app:
		...
		for commit in app_commits["Commit ID"]:
			commit_data = git_data.get_commit_stats(commit)
...
if __name__ == '__main__':
	for name in ["~/Downloads/Consistency Between Commit Message and Content - Neutral.csv",
				 "~/Downloads/Consistency Between Commit Message and Content - Breaker.csv"]:
